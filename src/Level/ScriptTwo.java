...
public abstract class ScriptTwo<T extends MapEntity> {
    ...
    protected boolean isTextboxQueueEmpty() {
        return map.getTextboxTwo().isTextQueueEmpty();
    }

    // remove textbox from screen
    protected void hideTextbox() {
        map.getTextboxTwo().setIsActive(false);
    }
